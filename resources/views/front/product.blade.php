        ...
        <div class="row ">
            ...
            <div class="col-md-7">
                <div class="bg-light right">
                    ...
                    <h2 class="price text-secondary"><del>{{$product->compare_price}} BDT</del></h2>
                    @endif
                    <h2 class="price ">{{$product->price}} BDT</h2>

                    <p><div class="10">{!!$product->short_description!!}</div></p>
...
<section class="pt-5 section-8">
    <div class="container">
        ...
        <div class="row flex-nowrap overflow-auto">
             ...
             @php
             $productImage=$related_product->product_images->first();
             @endphp
             <div class="col-md-3">
                <div class="card product-card">
                    ...
                    <div class="card-body text-center mt-3">
                        ...
                        <div class="price mt-2">
                            <span class="h5"><strong>{{$related_product->price}}BDT</strong></span>
                            @if ($related_product->compare_price>0)
                                <span class="h6 text-underline"><del>${{$related_product->compare_price}}BDT</del></span>
                            @endif
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    $("#productRatingForm").submit(function(event){
        ...
        $.ajax({
            url: '{{route("front.save_rating",$product->id)}}',
            type: 'post',
