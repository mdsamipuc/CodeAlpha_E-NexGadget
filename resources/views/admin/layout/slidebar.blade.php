<aside class="main-sidebar sidebar-dark-primary elevation-4"> 
    ...
    <style>
        ...
        .nav-link {
            color: white; /* Change link color to white for visibility */
        }
        .nav-link:hover {
            background-color: #003366; /* Lighter blue on hover */
        }
        .nav-icon {
    ...
    <a href="{{route('admin.dashboard')}}" class="brand-link">
        ...
        <span class="brand-text font-weight-light" style= "font-family: 'Bungee', cursive;">E-NexGadget</span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
