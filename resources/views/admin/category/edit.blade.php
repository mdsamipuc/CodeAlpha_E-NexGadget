                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input readonly type="text" name="slug" id="slug" value="{{$category->slug}}" class="form-control" placeholder="Slug">
                            <p></p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div>
                            <img src="{{asset('upload/category/'.$category->image)}}" width="250">
                        </div>
